...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsMissionEn mission = TranslationsMissionEn.internal(_root);
...
class TranslationsMissionEn {
	TranslationsMissionEn.internal(this._root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'anecdotes.la_serre_du_parc_de_la_tete_or': return 'Parc de la Tête d\'Or is a true nature escape right in the city! Opened in 1857, it\'s one of the biggest urban parks in France. And the greenhouse? A real tropical jungle in the heart of Lyon! Built in 1890, it houses rare and exotic plants. Perfect for feeling elsewhere without leaving town.';
