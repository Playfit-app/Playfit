...
class TranslationsFr extends Translations {
	...
	@override late final _TranslationsMissionFr mission = _TranslationsMissionFr._(_root);
	@override late final _TranslationsShopFr shop = _TranslationsShopFr._(_root);
	@override late final _TranslationsWorkoutFr workout = _TranslationsWorkoutFr._(_root);
}
...
class _TranslationsSocialFr extends TranslationsSocialEn {
	...
	@override String get no_posts_available => 'Aucun post disponible.';
	@override String get post_delete => 'Supprimer';
	@override String get post_report => 'Signaler';
}
...
// Path: mission
class _TranslationsMissionFr extends TranslationsMissionEn {
	_TranslationsMissionFr._(TranslationsFr root) : this._root = root, super.internal(root);
...
class _TranslationsShopFr extends TranslationsShopEn {
	...
	// Translations
	@override String get title => 'Boutique';
}

// Path: workout
class _TranslationsWorkoutFr extends TranslationsWorkoutEn {
	_TranslationsWorkoutFr._(TranslationsFr root) : this._root = root, super.internal(root);
